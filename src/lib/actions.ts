...
function normalizarInputNfse(input: NfseEmissaoInput): NfseEmissaoInput {
  ...
  return {
    ...
    indicadorOperacao: String(input.indicadorOperacao ?? ''),
    cstIss: String(input.cstIss ?? ''),
    classificacaoTributariaIbsCbs: String(input.classificacaoTributariaIbsCbs ?? ''),
    destinatarioServico: String(input.destinatarioServico ?? ''),
    ...
    tipoRetencaoPisCofinsCsll: String(input.tipoRetencaoPisCofinsCsll ?? ''),
    codigoSituacaoTributariaPisCofins: String(input.codigoSituacaoTributariaPisCofins ?? ''),
    baseCalculoPisCofins: numero(input.baseCalculoPisCofins),
    aliquotaPis: numero(input.aliquotaPis),
    aliquotaCofins: numero(input.aliquotaCofins),
